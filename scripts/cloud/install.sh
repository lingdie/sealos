...
execute_commands() {
    ...
    [[ $k8s_ready == "y" ]] || (get_prompt "cilium_requirement" && sealos run "${image_registry}/${image_repository}/cilium:v${cilium_version#v:-1.12.14}" --env ExtraValues="ipam.mode=kubernete"
    wait_cluster_ready
