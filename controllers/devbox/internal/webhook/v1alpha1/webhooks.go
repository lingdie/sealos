...
// var devboxlog = logf.Log.WithName("devbox-resource")

// SetupDevboxWebhookWithManager registers the webhook for Devbox in the manager.
func SetupDevboxWebhookWithManager(mgr ctrl.Manager) error {
