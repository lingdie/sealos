...
require (
	...
	github.com/labring/cri-shim v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/containerd/nerdctl/v2 v2.0.0-rc.0 // indirect
...
replace (
	github.com/AdamKorcz/go-fuzz-headers-1 => github.com/AdamKorcz/go-fuzz-headers-1 v0.0.0-20230919221257-8b5d3ce2d11d
	github.com/veraison/go-cose => github.com/veraison/go-cose v1.1.0
...
replace (
	github.com/labring/cri-shim => ./staging/src/github.com/labring/cri-shim
